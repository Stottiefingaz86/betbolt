      ...
      render: (active: boolean, reelId: string) => {
        ...
        useEffect(() => {
          if (active) {
            ...
            const confetti = new Confetti('confetti-target');
        ...
        return (
          <div className="relative h-app w-full">
            ...
            <div className="absolute left-6 bottom-24 z-20 max-w-lg">
              ...
              <Link 
                href="/rewards"
                className="bg-white text-black py-3 px-6 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-white/90 active:scale-95 mb-2 flex items-center justify-center space-x-2"
              >
